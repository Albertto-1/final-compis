...
var SLRParser = (function () {
    function SLRParser(fileName) {
        this.actionTable = {};
        this.gotosTable = {};
        this.grammarTable = {};
        this.stack = [0];
    ...
    SLRParser.prototype.loadActions = function () {
        var _this = this;
    ...
    SLRParser.prototype.loadGotos = function () {
        var _this = this;
    ...
    SLRParser.prototype.loadGrammar = function () {
        var _this = this;
    ...
    SLRParser.prototype.start = function () {
    ...
    SLRParser.prototype.eval = function () {
        utils_1.c('----------------------------------------------');
    ...
    SLRParser.prototype.printStacks = function () {
        utils_1.c('Stack: ' + this.stack);
        utils_1.c('Symbols: ' + this.symbols);
    };
    return SLRParser;
}());
exports.SLRParser = SLRParser;
